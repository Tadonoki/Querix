...
export function LessonDetailClient({ lesson }: { lesson: Lesson }) {
  ...
  return (
    <main className="bg-querix-paper py-10 lg:py-14">
      <div className="container grid gap-6 lg:grid-cols-[0.72fr_0.28fr] lg:gap-8">
        <section className="space-y-6 lg:space-y-8">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-base leading-8 text-foreground lg:text-lg lg:leading-9">
          ...
          <Card>
            ...
            <CardContent>
              <pre className="overflow-x-auto rounded-lg bg-slate-950 p-5 text-sm leading-7 text-slate-100 lg:p-6 lg:text-base lg:leading-8">
